...
import { createOperator } from "../../store/actions/operatorActions";
    ...
    return (
        <div className="container">
          <form className="white" onSubmit={handleSubmit(onSubmit)}>
            ...
            <div className="input-field">
              <button type="submit" disabled={!formState.isValid} className="btn pink lighten-1 z-depth-0">Create</button>
            </div>
          </form>
        </div>
      );
